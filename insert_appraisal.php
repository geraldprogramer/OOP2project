...
<h2 style="color:blue";>Insert Appraisal Details</h2>
<div class="form">
<form action="" method="POST" enctype="multipart/form-data">
  ...
  <input type="number" name="phone" placeholder="Enter driver's phone number..." required>
  <br>
...
if(isset($_POST['insert_btn'])){
  ...
  $insert="INSERT INTO appraisal (names, id_number,passport_photo, phone,integrity,discpline,punctuality,accident_free,decent,points, remarks )
  VALUES('$names', '$id_number', '$image','$phone','$integrity','$discpline','$punctuality','$accident_free','$decent','$points', '$remarks')";
