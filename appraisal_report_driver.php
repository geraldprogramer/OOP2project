...
<div class="secnav">
  ...
  <a href="#.php">xxx</a>-->
    ...
    <h2 style="color:blue; text-align:center;" >Appraisal Monthly Report</h2>
    <center>
<div class="form">
<form action="print_report.php" method="GET">
<input type="text" style="width: 20%;" name= "id_number" value= "<?php if (isset($fetch['id_number'])){echo $fetch['id_number'];}?>"></input>
