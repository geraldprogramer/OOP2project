...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="driver" placeholder="Enter full names of driver..." value="<?php echo $fetch['driver'] ?>" required>
    <br>
    <label for="phone">Phone of Driver </label><br>
    <input type="text" name="phone" placeholder="Enter phone number of driver..." value="<?php echo $fetch['phone'] ?>" required>
    <br>
    <label for="email">Email of Driver </label><br>
    <input type="text" name="email" placeholder="Enter email of driver..." value="<?php echo $fetch['email'] ?>" required>
    <br>
  
    <input type="submit" name="update_btn" value="Update">
    <a href="view_service.php" style="background-color: blue;color: white; padding: 8px 18px; text-align: center; text-decoration: none; border-radius: 5px;";>Cancel</a>
    ...
    if(isset($_POST['update_btn'])){
        ...
        $update="UPDATE maintenance SET vehicle_reg_no='$vehicle_reg_no', nickname='$nickname', last_service='$last_service', next_service='$next_service',driver='$driver',phone='$phone',email='$email' WHERE id='$id'";
