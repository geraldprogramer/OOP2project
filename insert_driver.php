...
<h2 style="color:blue";>Register Driver</h2>
<div class="form">
<form action="" method="POST" enctype="multipart/form-data">
  ...
  <input type="number" name="phone" placeholder="Enter phone number 1..." required>
<br>
<label for="phone2">Phone 2</label><br>
  <input type="number" name="phone2" placeholder="Enter phone number 2..." required>
<br>
