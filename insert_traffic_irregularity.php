...
<h2 style="color:blue";>Insert Traffic Irregularity Issue</h2>
<div class="form">
...
if(isset($_POST['insert_btn'])){
  ...
  $insert="INSERT INTO traffic_irregularity  (names, id_number,phone, passport_photo, traffic_irregularity, action_taken)
  VALUES('$names', '$id_number','$phone','$image', '$traffic_irregularity','$action_taken' )";
