...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <input type="submit" name="update_btn" value="Compute">
    <a href="view_revenue.php" style="background-color: blue;color: white; padding: 8px 18px; text-align: center; text-decoration: none; border-radius: 5px;";>Cancel</a>
    ...
    if(isset($_POST['update_btn'])){
        ...
        $update="UPDATE revenue SET date='$date', vehicle_reg_no='$vehicle_reg_no', psv_earnings_per_day='$psv_earnings_per_day', hired_earnings_per_day='$hired_earnings_per_day', expenses='$expenses', profit='$profit'  WHERE id='$id'";
