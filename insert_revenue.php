...
<h2 style="color:blue";> Insert Revenue</h2>
<div class="form">
<form action="" method="POST" enctype="multipart/form-data">
  ...
  <br>
  <input type="submit" name="insert_btn" value="Compute">
  <input type="reset">
...
$insert="INSERT INTO revenue (date, vehicle_reg_no,psv_earnings_per_day,hired_earnings_per_day,expenses,profit)
  VALUES('$date', '$vehicle_reg_no', '$psv_earnings_per_day','$hired_earnings_per_day','$expenses', '$profit')"; 
