...
<input type="text" style="width: 20%;" name= "id_number" value= "<?php if (isset($_GET['id_number']))
            {echo $_GET['id_number'];}?>"></input>
<!--<button type = "submit">Search</button>-->
<input type="submit" name="insert_btn" value="Search">
<!--<a href="print_report.php" class="btn btn-printing btn-lg"><span>Print Report</span></a>-->
<!-- <a href="view_driver.php" ><span>Back to Drivers List</span></a>-->
