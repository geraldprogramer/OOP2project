...
<div class="form">
<h2 style= "color:blue;">Edit Driver</h2>
<form action="" method="POST" enctype="multipart/form-data">
  ...
  <input type="number" name="phone" placeholder="Enter driver's phone number..." value="<?php echo $fetch['phone'] ?>" required>
  <br>
  <h3 style="color:blue";>Appraisal Section</h3>
  ...
  <select name="decent">
    ...
    <br>
        ...
        <input type="reset">
        <a href="view_appraisal.php" style="background-color: blue;color: white; padding: 8px 18px; text-align: center; text-decoration: none; border-radius: 5px;";>Cancel</a>
    ...
    if(isset($_POST['update_btn'])){
        ...
        if($image!="")
        {
            $update="UPDATE appraisal SET names='$names', id_number='$id_number', passport_photo='$image', phone='$phone', integrity='$integrity',discpline='$discpline', punctuality ='$punctuality',accident_free ='$accident_free', decent ='$decent', points ='$points', remarks='$remarks'  WHERE id='$id'";
            $update_q=mysqli_query($con,$update);
            header('location:view_appraisal.php');
        }
        else
        {
            $update="UPDATE appraisal SET names='$names', id_number='$id_number', phone='$phone', integrity='$integrity',discpline='$discpline', punctuality ='$punctuality',accident_free ='$accident_free',decent ='$decent',  points ='$points', remarks='$remarks'  WHERE id='$id'";
            $update_q=mysqli_query($con,$update);
            header('location:view_appraisal.php');        
        }
    }
