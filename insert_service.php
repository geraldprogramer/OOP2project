...
<h2 style="color:blue";> Insert Service Details</h2>
<div class="form">
...
$insert="INSERT INTO maintenance (vehicle_reg_no,nickname,last_service,next_service,status, remaining_days,driver,phone,email)
  VALUES('$vehicle_reg_no', '$nickname','$last_service','$next_service', '$status','$remaining_days','$driver','$phone','$email')"; 
