...
<div class="form">
<h2 style= "color:blue;">Edit Indiscpline Issue</h2>
<form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="reset">
        <a href="view_discplinary.php" style="background-color: blue;color: white; padding: 8px 18px; text-align: center; text-decoration: none; border-radius: 5px;";>Cancel</a>
