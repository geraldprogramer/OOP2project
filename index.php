...
<html lang="en">
   ...
   onpageshow="if (event.persisted) noBack();" onunload="">    <div class="header">
    <a href="#.php"><img src="/images/supremeshuttlelogo.png"></a>
        ...
        <a href="login-user.php" style="color:white;font-size: 15px; text-decoration:none; width:10%; border-radius:5px;height:35px;" > Login</a>
        <a href="home_driver.php" style="color:white;font-size: 15px; text-decoration:none; width:10%; border-radius:5px;height:35px; float:right;" > Driver Portal</a>
...
<div class="secnav">
  <!--<a href="#.php" style="float:right; background-color:green; width:7%; border-radius:5px;margin-right: 20px;">LOGIN</a>-->
    ...
    <h2 style="color:blue; text-align:center; " > Supreme Shuttle Management System</h2>
 <!---slideshow-->
